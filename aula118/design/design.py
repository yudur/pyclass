...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.inputValidaCPF, 0, 2, 1, 1)
        ...
        self.laberRetorno = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.laberRetorno.setFont(font)
        self.laberRetorno.setStyleSheet("color: green;")
        self.laberRetorno.setText("")
        self.laberRetorno.setAlignment(QtCore.Qt.AlignCenter)
        self.laberRetorno.setObjectName("laberRetorno")
        self.gridLayout.addWidget(self.laberRetorno, 2, 0, 1, 4)
